...
export const useThemStore = defineStore('them', () => {
    ...
    // 默认背景图
    const defaultHeaderImg = "https://poloblog-smilling1123.cloud/files/myblog/cb90ee30-ff45-4406-9d82-b3404cd4cad2.png"//"http://localhost:9000/myblog/0100312000iznjmym62D5_W_2048_1536.jpg_.webp"
